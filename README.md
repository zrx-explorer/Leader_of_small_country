...
- 🎴 **21 张随机事件卡**：每个选项都有实际收益与代价，部分选择会改变阶级人口并引出两年后的连锁事件
- 🎛️ **轻重两套操作**：一键政策方案与“推进至决策”适合轻松游玩，高级调控保留完整数值空间
...
| 本地单文件 | [`play.html`](./play.html) | 直接双击打开即可游玩 |
...
1. **任命**：一键选择休养生息 / 均衡治理 / 富国强兵，或展开高级调控细分税务、治安、民生、军事、教师配额与公务员工资
2. **结算**：自动计算粮食产出 / 税收 / 工资 / 教育 / 军事 / 满意度 / 治安 / 出生死亡
3. **决策**：每 3 年调整一次政策，应对随机事件；也可自动推进到下一次事件、战争或政策窗口
...
| 章节 | 目标年限 | 胜利条件 | 失败条件 |
|---|---|---|---|
| 第一章 · 立国 | 30 年 | 人口 ≥ 20 且平均满意度 ≥ -15；达成后继续经营 | 国库连续破产 / 人口归零 / 革命爆发 |
